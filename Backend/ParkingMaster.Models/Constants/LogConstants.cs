...
namespace ParkingMaster.Models.Constants
{
    public static class LogConstants
    {
        ...
        public static string temp = @"C:\ParkingMaster\LOGS";
        //FILE & DIRECTORY CONSTANTS
        public static readonly string PATH_LOG_FAILURES = @"C:\ParkingMaster\LOG_FAILURE_COUNT.json";
        public static readonly string PATH_LOG_DIRECTORY = @"C:\ParkingMaster\LOGS";
        public static string PATH_LOG_CURRENT = @"C:\ParkingMaster\LOGS\Logs.json"; //OVERRIDABLE
